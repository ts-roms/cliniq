...
const STATUS_LABEL: Record<DentalLabTreatmentPlanStatus, string> = {
  DRAFT: 'Draft',
  PROPOSED: 'Proposed',
  APPROVED: 'Approved',
  REJECTED: 'Rejected',
...
const STATUS_COLOR: Record<DentalLabTreatmentPlanStatus, string> = {
...
function DecisionButtons({ id }: { id: string }) {
  ...
  function go(decision: DentalLabTreatmentPlanDecision) {
    decide.mutate(
...
function EditableSummary({ plan }: { plan: DentalLabTreatmentPlan }) {
