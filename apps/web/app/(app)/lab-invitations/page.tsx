    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Invitations from dental laboratories. Accepting unlocks ordering with
          that lab.
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          ...
          {!isLoading && data && data.length === 0 && (
            <p className="text-sm text-muted-foreground">
              No invitations yet. Once a lab adds your clinic by slug, the
