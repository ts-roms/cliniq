 ...
 */
@Injectable()
export class DentalLabStatsService {
  ...
  async overview(user: AuthenticatedUser) {
    return this.prisma.withTenant(user.tenantId, user.userId, async (tx) => {
      ...
      return {
        ...
        ) as Record<DentalLabCaseStatus, number>,
        openCases,
