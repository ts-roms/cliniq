 ...
 *   • DentalLabInvoicesService — invoice PDFs.
 *   • DentalLabComplianceService — conformity declarations on shipment.
 *
 ...
 */
@Injectable()
export class DentalLabPdfRenderingService {
  private readonly logger = new Logger(DentalLabPdfRenderingService.name);
  ...
  drawLetterhead(
    ...
    doc
      .font('Helvetica-Bold')
      .fontSize(20)
      .text(opts.labName, { continued: false });
    ...
    while (row < rows.length) {
      ...
      for (let c = 0; c < columns; c += 1) {
        ...
        doc
          ...
          .fontSize(8)
          .fillColor('#666')
          .text(r.label.toUpperCase(), x, yStart, {
            width: colW - 12,
            lineGap: 1,
          });
        doc
