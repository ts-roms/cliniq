 ...
 * inline — `include: { lab: {...} }` on a DentalLabClinicLink / DentalLabCase /
 * DentalLabInvoice, and `clinic: {...}` on the mirror routes. All of them silently
...
@Injectable()
export class DentalLabCounterpartyService {
