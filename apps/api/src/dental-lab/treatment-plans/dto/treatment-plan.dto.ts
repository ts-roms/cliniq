...
export class PresignTreatmentPlanFileDto {
  ...
  @ApiPropertyOptional({
    ...
    enumName: 'DentalLabTreatmentPlanFileKind',
  })
  @IsOptional()
  @IsEnum(DentalLabTreatmentPlanFileKind)
...
export class DecideTreatmentPlanDto {
  @ApiProperty({
    ...
    enumName: 'DentalLabTreatmentPlanDecision',
  })
  @IsEnum(DentalLabTreatmentPlanDecision)
