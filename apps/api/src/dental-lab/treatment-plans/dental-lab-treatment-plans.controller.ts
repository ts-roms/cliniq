...
import { DentalLabTreatmentPlansService } from './dental-lab-treatment-plans.service.js';
import {
...
/**
 * Lab-side: compose, propose, attach files. Mounted at /api/dental-lab/treatment-plans.
 * Gated by LAB_TREATMENT_PLAN (Premium-only feature).
 */
@ApiTags('lab-treatment-plans')
@ApiBearerAuth('jwt')
@RequiresFeature(Features.LAB_TREATMENT_PLAN)
@Controller('dental-lab/treatment-plans')
export class DentalLabTreatmentPlansController {
  ...
  @Audit({
    ...
    entity: 'DentalLabTreatmentPlanFile',
   ...
   * the lab pastes into the plan editor (DentalLabTreatmentPlan.summary). Gated
