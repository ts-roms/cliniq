...
import { DentalLabMaterialsService } from './dental-lab-materials.service.js';
import {
  CreateLotDto,
  CreateMaterialDto,
  RecordUsageDto,
...
export class DentalLabMaterialsController {
  constructor(private readonly mats: DentalLabMaterialsService) {}
