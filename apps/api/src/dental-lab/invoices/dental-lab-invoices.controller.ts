...
import { DentalLabInvoicesService } from './dental-lab-invoices.service.js';
import {
...
/**
 * Lab-side invoice management. Mounted at /api/dental-lab/invoices.
 *
...
@Controller('dental-lab/invoices')
export class DentalLabInvoicesController {
