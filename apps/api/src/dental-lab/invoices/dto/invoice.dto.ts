...
import { DentalLabInvoiceStatus, DentalLabPaymentLinkProvider } from '@org/db';

/**
 * Single line item on a lab invoice. Either tied to a case (auto-generated
 * from a delivered DentalLabCase) or free-form (custom service / discount /
 * adjustment). Money is in centavos.
 */
export class DentalLabInvoiceItemInputDto {
  @ApiPropertyOptional({
    description: 'Optional DentalLabCase id this line bills for.',
  })
  @IsOptional()
  @IsString()
  caseId?: string;
...
export class CreateLabInvoiceDto {
  ...
  @ApiPropertyOptional({ type: [DentalLabInvoiceItemInputDto] })
  @IsOptional()
  @IsArray()
  @ArrayMaxSize(200)
  @ValidateNested({ each: true })
  @Type(() => DentalLabInvoiceItemInputDto)
  items?: DentalLabInvoiceItemInputDto[];
}
...
export class GenerateFromCasesDto {
  ...
  @ApiProperty({ type: [String], description: 'DentalLabCase ids to bill.' })
  @IsArray()
  @ArrayMinSize(1)
  @ArrayMaxSize(200)
  @IsString({ each: true })
...
export class AddLabInvoiceItemDto extends DentalLabInvoiceItemInputDto {}
...
export class CreatePaymentLinkDto {
  @ApiPropertyOptional({
    ...
    enumName: 'DentalLabPaymentLinkProvider',
    default: DentalLabPaymentLinkProvider.MANUAL,
  })
  @IsOptional()
  @IsEnum(DentalLabPaymentLinkProvider)
...
export class InvoiceFilterDto {
  @ApiPropertyOptional({
    ...
    enumName: 'DentalLabInvoiceStatus',
  })
  @IsOptional()
  @IsEnum(DentalLabInvoiceStatus)
