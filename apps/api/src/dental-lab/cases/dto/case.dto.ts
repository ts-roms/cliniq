...
import { DentalLabCaseStatus, DentalLabCaseUrgency } from '@org/db';
...
export class CreateLabCaseDto {
  ...
  @ApiPropertyOptional({
    ...
    enumName: 'DentalLabCaseUrgency',
  })
  @IsOptional()
  @IsEnum(DentalLabCaseUrgency)
...
export class TransitionLabCaseDto {
  @ApiProperty({ enum: DentalLabCaseStatus, enumName: 'DentalLabCaseStatus' })
  @IsEnum(DentalLabCaseStatus)
...
export class DentalLabCaseListQueryDto {
  @ApiPropertyOptional({
    enum: DentalLabCaseStatus,
    enumName: 'DentalLabCaseStatus',
  })
  @IsOptional()
  @IsEnum(DentalLabCaseStatus)
  status?: DentalLabCaseStatus;
