...
import { DentalLabComplianceService } from './dental-lab-compliance.service.js';
import {
  CaptureSignatureDto,
  CreateTemplateDto,
  UpdateTemplateDto,
...
@ApiBearerAuth('jwt')
@Controller()
export class DentalLabComplianceController {
  constructor(private readonly compliance: DentalLabComplianceService) {}

  // ── Conformity templates (lab only) ──────────────────────

  @Get('dental-lab/conformity-templates')
  ...
  @Post('dental-lab/conformity-templates')
  @HttpCode(HttpStatus.CREATED)
  @Requires(Actions.TENANT_MANAGE)
  @RequiresFeature(Features.LAB_CONFORMITY_DOCS)
  @Audit({
    action: 'lab.conformity.create',
    entity: 'DentalLabConformityDocTemplate',
  ...
  @Patch('dental-lab/conformity-templates/:id')
  @Requires(Actions.TENANT_MANAGE)
  @RequiresFeature(Features.LAB_CONFORMITY_DOCS)
  updateConformity(
    @Param('id') id: string,
  ...
  @Delete('dental-lab/conformity-templates/:id')
  ...
  @Get('dental-lab/consent-templates')
  @Requires(Actions.TENANT_MANAGE)
  ...
  @Post('dental-lab/consent-templates')
  @HttpCode(HttpStatus.CREATED)
  @Requires(Actions.TENANT_MANAGE)
  @RequiresFeature(Features.LAB_CONSENT_ESIGN)
  @Audit({
    action: 'lab.consent.create',
    entity: 'DentalLabConsentTemplate',
    entityIdFrom: 'result:id',
  })
  createConsent(
    @Body() dto: CreateTemplateDto,
  ...
  @Patch('dental-lab/consent-templates/:id')
  @Requires(Actions.TENANT_MANAGE)
  @RequiresFeature(Features.LAB_CONSENT_ESIGN)
  updateConsent(
    @Param('id') id: string,
  ...
  @Delete('dental-lab/consent-templates/:id')
  @HttpCode(HttpStatus.NO_CONTENT)
  @Requires(Actions.TENANT_MANAGE)
  @RequiresFeature(Features.LAB_CONSENT_ESIGN)
  removeConsent(
  ...
  @Get('dental-lab/cases/:caseId/signatures')
  @Requires(Actions.TENANT_MANAGE)
  listSignaturesLab(
  ...
  @Audit({
    ...
    entity: 'DentalLabConsentSignature',
    entityIdFrom: 'result:id',
  })
  captureFromClinic(
    @Param('caseId') caseId: string,
  ...
  @Post('dental-lab/cases/:caseId/signatures')
  @HttpCode(HttpStatus.CREATED)
  @Requires(Actions.TENANT_MANAGE)
  @Audit({
  ...
  @Post('dental-lab/cases/:caseId/conformity-pdf')
