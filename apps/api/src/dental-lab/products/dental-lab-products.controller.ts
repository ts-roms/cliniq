...
import { DentalLabProductsService } from './dental-lab-products.service.js';
import {
...
export class DentalLabProductsController {
  constructor(private readonly products: DentalLabProductsService) {}
  ...
  @Audit({
    ...
    entity: 'DentalLabProductCategory',
