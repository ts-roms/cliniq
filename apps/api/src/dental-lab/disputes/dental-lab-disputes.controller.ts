...
import { DentalLabDisputesService } from './dental-lab-disputes.service.js';
import {
  DisputeMessageDto,
  OpenDisputeDto,
  ResolveDisputeDto,
...
/**
 * Lab-side disputes. Mounted at /api/dental-lab/disputes. Gated by
...
@Controller('dental-lab/disputes')
export class DentalLabDisputesController {
