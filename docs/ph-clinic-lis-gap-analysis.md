...
> | Built                                                                                                                         | Still missing                                                   |
> | ----------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
> | Test catalogue — `LaboratoryTest`, `TestComponent`, `LabSection` (`20260924180000_lis_test_catalogue`)                        | `PATHOLOGIST` / `MEDICAL_TECHNOLOGIST` roles + supervision link |
...
> | Acknowledged critical-result notifications (`20260924120000_critical_result_notifications`)                                   | The referral MOA file                                           |
> | Result verification chain (`20260924220000_lis_result_verification`); signed reports + PDF (`20260924240000_lis_lab_reports`) | The Levey-Jennings chart (UI over `QcRun`)                      |
...
| P0-5 DOH-licensable laboratory                      | partially closed | catalogue, specimens, verification chain, signed reports, licence profile, referrals, equipment, EQAP, internal QC; `PATHOLOGIST` / `MEDICAL_TECHNOLOGIST` roles still open |
