...
- An **append-only audit log** enforced at the grant level — `GRANT SELECT, INSERT` only, deliberately no UPDATE/DELETE (`libs/db/prisma/migrations/20260502160000_audit_and_files/migration.sql:40-41`).
